...
//            GLog.d(TAG, messageUserInfo.toString());
    ...
    protected void updateTitleBar(final boolean isContact) {
        ...
        mTitleBar.setRightImageViewListener(new View.OnClickListener() {//编辑
            @Override
            public void onClick(View v) {
                ...
                if (isContact) {
                    dialog.initDialog(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            getString(com.android.gmacs.R.string.edit_remark), getString(com.android.gmacs.R.string.report),
                            getString(com.android.gmacs.R.string.delete_contact)}).create().show();
                } else {
                    dialog.initDialog(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    }).setListTexts(new String[]{getString(com.android.gmacs.R.string.add_contact)}).create().show();
                }
            }
        });
