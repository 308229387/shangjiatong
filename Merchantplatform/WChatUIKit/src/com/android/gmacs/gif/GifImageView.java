...
public class GifImageView extends ImageView {
	...
	/**
	 * 将指定的asset中的内容加载为Gif动画信息
	 *
	 * @param assetName
	 */
	public void setGifImageByAssetName(String assetName) {
		if (!GifViewUtils.setGifImageAssetName(this, assetName)) {
			super.setBackgroundResource(0);
		}
	}

	public void setGifByFilePath(String filePath) {
		if (!GifViewUtils.setGifImageFilePath(this, filePath)) {
			super.setBackgroundResource(0);
		}
	}

	public void setGifImageDrawable(GifDrawable gifDrawable) {
		if (!GifViewUtils.setGifImageDrawable(this, gifDrawable)) {
			super.setBackgroundResource(0);
		}
	}
