...
public class ParallaxBackLayout extends FrameLayout {
    ...
    public ParallaxBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mShadowLeft = getResources().getDrawable(R.drawable.gmacs_shadow_left);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        String activityClassName = mSwipeHelper.getActivity().getClass().getSimpleName();
        if (!mEnable || GmacsImageActivity.class.getSimpleName().equals(activityClassName)) {
            return false;
        }
        try {
