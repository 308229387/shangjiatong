...
public class CommonGlobalDialog extends Dialog implements View.OnClickListener {
    ...
    public CommonGlobalDialog(Context context) {
        super(context, R.style.DialogWithAnim);
        mContext = context;
    }

    public CommonGlobalDialog(Context context, int theme){
        super(context,theme);
        setCancelable(false);
