...
public class SwipeMenuLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final boolean measureMatchParentChildren = View.MeasureSpec.getMode(heightMeasureSpec) != View.MeasureSpec.EXACTLY;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView.getVisibility() != GONE) {
                ...
                final ViewGroup.MarginLayoutParams lp = (ViewGroup.MarginLayoutParams) childView.getLayoutParams();
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        int uniformMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(),
